  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-20">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#6EE7B7]/20 rounded-full blur-[128px] animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-8 -right-8 w-24 h-24 rounded-full bg-gradient-to-br from-[#A26BFF]/40 to-[#6EE7B7]/40 backdrop-blur-xl border border-white/20 flex items-center justify-center"
            >
